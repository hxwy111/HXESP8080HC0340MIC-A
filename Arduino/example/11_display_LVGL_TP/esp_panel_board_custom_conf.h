 ...
 */
#define ESP_PANEL_BOARD_NAME                "HXESP8080HC340MIC-A"
 ...
 */
    ...
    #define ESP_PANEL_BOARD_LCD_MIPI_DSI_LANE_RATE_MBPS     (500)  // Single lane bit rate, should check the LCD drive IC
    ...
    #define ESP_PANEL_BOARD_LCD_MIPI_DPI_CLK_MHZ            (44) // 库 1.0.4 使用整数 MHz，约 59.52 Hz
    ...
    #define ESP_PANEL_BOARD_LCD_MIPI_DPI_VFP                (24)
    /* For DSI power PHY */
...
// 使用本屏厂家命令，避免回退到库内其他面板的默认表。
#include "jd9365_board_init.h"
...
#define ESP_PANEL_BOARD_BACKLIGHT_TYPE          (ESP_PANEL_BACKLIGHT_TYPE_SWITCH_GPIO)
     ...
     */
    #define ESP_PANEL_BOARD_BACKLIGHT_IO        (33)    // Output GPIO pin number
